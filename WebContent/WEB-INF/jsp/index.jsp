	...
	<div class="slider-area">
		...
		<div class="block-slider block-slider4">
			<ul class="" id="bxslider-home4">
				<li><img
					src="${pageContext.request.contextPath}/resources/img/h4-slide.png"
					alt="Slide">
				...
				<li><img
					src="${pageContext.request.contextPath}/resources/img/h4-slide2.png"
					alt="Slide">
					<div class="caption-group">
						<h2 class="caption title">
							by one, get one <span class="primary">50% <strong>off</strong></span>
						</h2>
						<h4 class="caption subtitle">school supplies &amp;
							backpacks.*</h4>
						<a class="caption button-radius" href="#"><span class="icon"></span>Shop
							now</a>
					</div></li>
				<li><img
					src="${pageContext.request.contextPath}/resources/img/h4-slide3.png"
					alt="Slide">
					<div class="caption-group">
						<h2 class="caption title">
				...
				<li><img
					src="${pageContext.request.contextPath}/resources/img/h4-slide4.png"
					alt="Slide">
					<div class="caption-group">
						<h2 class="caption title">
							Apple <span class="primary">Store <strong>Ipod</strong></span>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="single-product-widget">
						...
						<div class="single-wid-product">
							<a href="single-product.html"><img
								src="${pageContext.request.contextPath}/resources/img/product-thumb-4.jpg"
								alt="" class="product-thumb"></a>
							<h2>
