			...
			<div class="row">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li><a href="${pageContext.request.contextPath}/shop">Shop
								page</a></li>
						<li class="active"><a
												...
												<c:forEach items="${cart.products}" var="product">
													<tr class="cart_item">
														<td class="product-remove"><a
															title="Remove this item" class="remove" href="#">×</a></td>

														<td class="product-thumbnail"><a
															href="single-product.html"><img width="145"
																height="145" alt="poster_1_up" class="shop_thumbnail"
																src="${product.key.image}"></a></td>

														<td class="product-name"><a
															href="product/${product.key.productID}">${product.key.name}</a></td>

														<td class="product-price"><span class="amount">
																<fmt:formatNumber type="currency" currencySymbol="$"
																	maxFractionDigits="2" value="${product.key.price}"></fmt:formatNumber>
														</span></td>
														...
														<td class="product-quantity">
															<div class="quantity buttons_added">
																<input type="button" class="minus" value="-"> <input
																	...
																	title="Qty" value="${product.value}" min="0" step="1">
																<input type="button" class="plus" value="+">
															</div>
														</td>

														<td class="product-subtotal"><span class="amount"><fmt:formatNumber type="currency" currencySymbol="$"
																	maxFractionDigits="2" value="${product.key.price * product.value}"></fmt:formatNumber></span>
														</td>
													</tr>
												</c:forEach>
												<tr>
													<td class="actions" colspan="6">
														...
														</div> <input type="submit" value="Update Cart"
														name="update_cart" class="button"> <input
														type="submit" value="Checkout" name="proceed"
										...
										<form method="post" action="#" class="shipping_calculator">
											<h2>
												<a class="shipping-calculator-button" data-toggle="collapse"
													...
													aria-controls="calcalute-shipping-wrap">Calculate
													Shipping</a>
											</h2>
											...
											<section id="calcalute-shipping-wrap"
												...
												<p class="form-row form-row-wide">
													<jsp:include page="include/countries.jsp" />
												</p>

												<p class="form-row form-row-wide">
													<input type="text" id="calc_shipping_state"
														name="calc_shipping_state" placeholder="State / county"
														value="" class="input-text">
												</p>

												<p class="form-row form-row-wide">
													<input type="text" id="calc_shipping_postcode"
														name="calc_shipping_postcode" placeholder="Postcode / Zip"
														value="" class="input-text">
												</p>
												...
												<p>
													<button class="button" value="1" name="calc_shipping"
														type="submit">Update Totals</button>
												</p>
